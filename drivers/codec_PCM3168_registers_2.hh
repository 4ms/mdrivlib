...
constexpr uint8_t DevBaseAddress = 0b10001000; // Shifted address, PCM3168 datasheet section 9.3.14

struct ResetControl : ReadWrite {
	static constexpr uint8_t Address = 0x40;

	uint8_t DacSamplingMode : 2;
	uint8_t : 4;
	uint8_t SystemResetResync : 1;
	uint8_t ModeReset : 1;

	enum DacSamplingMode : uint8_t { Auto = 0, Single = 0b01, Dual = 0b10, Quad = 0b11 } : 2;
};
