...
public:
	...
	SaiPdmPeriph(const SaiConfig &def)
		: saidef_(def) {
	}

	~SaiPdmPeriph() = default;
	...
	void set_callbacks(Interrupt::ISRType &&rx_complete_cb, Interrupt::ISRType &&rx_half_complete_cb);
...
private:
	...
	Interrupt::ISRType rx_tc_cb;
	Interrupt::ISRType rx_ht_cb;
