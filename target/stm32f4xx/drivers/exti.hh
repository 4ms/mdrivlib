...
using RTSR = RegisterBits<ReadWrite, EXTI_BASE + offsetof(EXTI_TypeDef, RTSR), 0x00E7FFFF>;
using FTSR = RegisterBits<ReadWrite, EXTI_BASE + offsetof(EXTI_TypeDef, FTSR), 0x00E7FFFF>;

// Interrupt and Event enables:
using IMR = RegisterBits<ReadWrite, EXTI_BASE + offsetof(EXTI_TypeDef, IMR), 0x00E7FFFF>;
using EMR = RegisterBits<ReadWrite, EXTI_BASE + offsetof(EXTI_TypeDef, EMR), 0x00E7FFFF>;
using SWIER = RegisterBits<ReadWrite, EXTI_BASE + offsetof(EXTI_TypeDef, SWIER), 0x00E7FFFF>;

// Rising/Falling trigger pending (read, then write 1 to clear)
using PR = RegisterBits<ReadWrite, EXTI_BASE + offsetof(EXTI_TypeDef, PR), 0x00E7FFFF>;
