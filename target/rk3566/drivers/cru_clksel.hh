...
enum class mclk_i2s_8ch_sel {
	clk_i2s_8ch_src = 0b00 << 10,  // e.g. clk_i2s1_8ch_tx_src or clk_i2s1_8ch_rx_src in TRM
	clk_i2s_8ch_frac = 0b01 << 10, // e.g. clk_i2s1_8ch_tx_frac or clk_i2s1_8ch_rx_frac in TRM
	i2s_mclkin = 0b10 << 10,	   // e.g. i2s1_mclkin in TRM
	xin_osc0_half = 0b11 << 10,
};
...
enum class hclk_gic_audio_clock_mux {
	clk_gpll_div_150m = 0b00 << 10,
	clk_gpll_div_100m = 0b01 << 10,
	clk_gpll_div_75m = 0b10 << 10,
	xin_osc0_func_mux = 0b11 << 10,
};
using hclk_gic_audio_sel = RegisterMaskedChoice<CLKSEL::reg(10), (0b11 << 10), hclk_gic_audio_clock_mux>;
