...
private:
	void write(auto opt, int offset) volatile {
		...
		// offset 0x00: 0x0007'0000 | opt << 0
		// offset 0x04: 0x0070'0000 | opt << 4
		// offset 0x08: 0x0700'0000 | opt << 8
		// offset 0x0C: 0x7000'0000 | opt << 12
		reg = mask | val;
...
using GPIO4A_IOMUX_H =
	GPIO_IOMUX<GPIO4A_IOMUX_H_SEL_4, GPIO4A_IOMUX_H_SEL_5, GPIO4A_IOMUX_H_SEL_6, GPIO4A_IOMUX_H_SEL_7>;
