...
private:
	void write(auto opt, int offset) volatile {
		reg = (static_cast<uint32_t>(opt) << (0x10 + offset)) | (0xffff);
	}
};
...
using GPIO1A_IOMUX_L =
	GPIO_IOMUX<GPIO1A_IOMUX_L_SEL_3, GPIO1A_IOMUX_L_SEL_2, GPIO1A_IOMUX_L_SEL_1, GPIO1A_IOMUX_L_SEL_0>;
using GPIO1A_IOMUX_H =
	GPIO_IOMUX<GPIO1A_IOMUX_H_SEL_7, GPIO1A_IOMUX_H_SEL_6, GPIO1A_IOMUX_H_SEL_5, GPIO1A_IOMUX_H_SEL_4>;

using GPIO1B_IOMUX_L =
	GPIO_IOMUX<GPIO1B_IOMUX_L_SEL_3, GPIO1B_IOMUX_L_SEL_2, GPIO1B_IOMUX_L_SEL_1, GPIO1B_IOMUX_L_SEL_0>;
using GPIO1B_IOMUX_H =
	GPIO_IOMUX<GPIO1B_IOMUX_H_SEL_7, GPIO1B_IOMUX_H_SEL_6, GPIO1B_IOMUX_H_SEL_5, GPIO1B_IOMUX_H_SEL_4>;

using GPIO1C_IOMUX_L =
	GPIO_IOMUX<GPIO1C_IOMUX_L_SEL_3, GPIO1C_IOMUX_L_SEL_2, GPIO1C_IOMUX_L_SEL_1, GPIO1C_IOMUX_L_SEL_0>;
using GPIO1C_IOMUX_H =
	GPIO_IOMUX<GPIO1C_IOMUX_H_SEL_7, GPIO1C_IOMUX_H_SEL_6, GPIO1C_IOMUX_H_SEL_5, GPIO1C_IOMUX_H_SEL_4>;

using GPIO1D_IOMUX_L =
	GPIO_IOMUX<GPIO1D_IOMUX_L_SEL_3, GPIO1D_IOMUX_L_SEL_2, GPIO1D_IOMUX_L_SEL_1, GPIO1D_IOMUX_L_SEL_0>;
using GPIO1D_IOMUX_H =
	GPIO_IOMUX<GPIO1D_IOMUX_H_SEL_7, GPIO1D_IOMUX_H_SEL_6, GPIO1D_IOMUX_H_SEL_5, GPIO1D_IOMUX_H_SEL_4>;

using GPIO2A_IOMUX_L =
	GPIO_IOMUX<GPIO2A_IOMUX_L_SEL_3, GPIO2A_IOMUX_L_SEL_2, GPIO2A_IOMUX_L_SEL_1, GPIO2A_IOMUX_L_SEL_0>;
using GPIO2A_IOMUX_H =
	GPIO_IOMUX<GPIO2A_IOMUX_H_SEL_7, GPIO2A_IOMUX_H_SEL_6, GPIO2A_IOMUX_H_SEL_5, GPIO2A_IOMUX_H_SEL_4>;

using GPIO2B_IOMUX_L =
	GPIO_IOMUX<GPIO2B_IOMUX_L_SEL_3, GPIO2B_IOMUX_L_SEL_2, GPIO2B_IOMUX_L_SEL_1, GPIO2B_IOMUX_L_SEL_0>;
using GPIO2B_IOMUX_H =
	GPIO_IOMUX<GPIO2B_IOMUX_H_SEL_7, GPIO2B_IOMUX_H_SEL_6, GPIO2B_IOMUX_H_SEL_5, GPIO2B_IOMUX_H_SEL_4>;

using GPIO2C_IOMUX_L =
	GPIO_IOMUX<GPIO2C_IOMUX_L_SEL_3, GPIO2C_IOMUX_L_SEL_2, GPIO2C_IOMUX_L_SEL_1, GPIO2C_IOMUX_L_SEL_0>;
using GPIO2C_IOMUX_H = GPIO_IOMUX<GPIOX_RESERVED, GPIO2C_IOMUX_H_SEL_6, GPIO2C_IOMUX_H_SEL_5, GPIO2C_IOMUX_H_SEL_4>;

using GPIO2D_IOMUX_L =
	GPIO_IOMUX<GPIO2D_IOMUX_L_SEL_3, GPIO2D_IOMUX_L_SEL_2, GPIO2D_IOMUX_L_SEL_1, GPIO2D_IOMUX_L_SEL_0>;
using GPIO2D_IOMUX_H =
	GPIO_IOMUX<GPIO2D_IOMUX_H_SEL_7, GPIO2D_IOMUX_H_SEL_6, GPIO2D_IOMUX_H_SEL_5, GPIO2D_IOMUX_H_SEL_4>;

using GPIO3A_IOMUX_L =
	GPIO_IOMUX<GPIO3A_IOMUX_L_SEL_3, GPIO3A_IOMUX_L_SEL_2, GPIO3A_IOMUX_L_SEL_1, GPIO3A_IOMUX_L_SEL_0>;
using GPIO3A_IOMUX_H =
	GPIO_IOMUX<GPIO3A_IOMUX_H_SEL_7, GPIO3A_IOMUX_H_SEL_6, GPIO3A_IOMUX_H_SEL_5, GPIO3A_IOMUX_H_SEL_4>;

using GPIO3B_IOMUX_L =
	GPIO_IOMUX<GPIO3B_IOMUX_L_SEL_3, GPIO3B_IOMUX_L_SEL_2, GPIO3B_IOMUX_L_SEL_1, GPIO3B_IOMUX_L_SEL_0>;
using GPIO3B_IOMUX_H =
	GPIO_IOMUX<GPIO3B_IOMUX_H_SEL_7, GPIO3B_IOMUX_H_SEL_6, GPIO3B_IOMUX_H_SEL_5, GPIO3B_IOMUX_H_SEL_4>;

using GPIO3C_IOMUX_L =
	GPIO_IOMUX<GPIO3C_IOMUX_L_SEL_3, GPIO3C_IOMUX_L_SEL_2, GPIO3C_IOMUX_L_SEL_1, GPIO3C_IOMUX_L_SEL_0>;
using GPIO3C_IOMUX_H =
	GPIO_IOMUX<GPIO3C_IOMUX_H_SEL_7, GPIO3C_IOMUX_H_SEL_6, GPIO3C_IOMUX_H_SEL_5, GPIO3C_IOMUX_H_SEL_4>;

using GPIO3D_IOMUX_L =
	GPIO_IOMUX<GPIO3D_IOMUX_L_SEL_3, GPIO3D_IOMUX_L_SEL_2, GPIO3D_IOMUX_L_SEL_1, GPIO3D_IOMUX_L_SEL_0>;
using GPIO3D_IOMUX_H =
	GPIO_IOMUX<GPIO3D_IOMUX_H_SEL_7, GPIO3D_IOMUX_H_SEL_6, GPIO3D_IOMUX_H_SEL_5, GPIO3D_IOMUX_H_SEL_4>;

using GPIO4A_IOMUX_L =
	GPIO_IOMUX<GPIO4A_IOMUX_L_SEL_3, GPIO4A_IOMUX_L_SEL_2, GPIO4A_IOMUX_L_SEL_1, GPIO4A_IOMUX_L_SEL_0>;
...
using GPIO4B_IOMUX_L =
	GPIO_IOMUX<GPIO4B_IOMUX_L_SEL_3, GPIO4B_IOMUX_L_SEL_2, GPIO4B_IOMUX_L_SEL_1, GPIO4B_IOMUX_L_SEL_0>;
using GPIO4B_IOMUX_H =
	GPIO_IOMUX<GPIO4B_IOMUX_H_SEL_7, GPIO4B_IOMUX_H_SEL_6, GPIO4B_IOMUX_H_SEL_5, GPIO4B_IOMUX_H_SEL_4>;

using GPIO4C_IOMUX_L =
	GPIO_IOMUX<GPIO4C_IOMUX_L_SEL_3, GPIO4C_IOMUX_L_SEL_2, GPIO4C_IOMUX_L_SEL_1, GPIO4C_IOMUX_L_SEL_0>;
using GPIO4C_IOMUX_H =
	GPIO_IOMUX<GPIO4C_IOMUX_H_SEL_7, GPIO4C_IOMUX_H_SEL_6, GPIO4C_IOMUX_H_SEL_5, GPIO4C_IOMUX_H_SEL_4>;

using GPIO4D_IOMUX_L = GPIO_IOMUX<GPIOX_RESERVED, GPIO4D_IOMUX_L_SEL_2, GPIO4D_IOMUX_L_SEL_1, GPIO4D_IOMUX_L_SEL_0>;

} // namespace Rockchip

// inline void example()
//{
//	PMU->gpio_a_h.write(GPIO0A_IOMUX_H_SEL_4::SDMMC0_DET);
//
//	// compile time error, can't set gpio B with gpio C options
//	PMU->gpio_b_l.write(GPIO0C_IOMUX_H_SEL_4::PWM5);
// }
