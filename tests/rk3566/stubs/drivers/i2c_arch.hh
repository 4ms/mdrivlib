...
struct I2C {
	...
	std::vector<uint32_t> test_tx_log;
	...
	void tx_data(unsigned wordnum, uint32_t val) {
		TXDATA[wordnum] = val;
		test_tx_log.push_back(val);
		printf("TXDATA[%u] = 0x%08x\n", wordnum, val);
		IPD = (1 << 2);
	}
	//
	// Events/interrupts
	...
	bool wait_for_pending_bit(EventBits bit) {
	...
	void clock_div(uint16_t SCL_high, uint16_t SCL_low) {
	...
	void enable_edge_glitch_filter() {
		DBGCTRL = DBGCTRL | std::to_underlying(DBGCTRL_bits::glitch_filter);
	}
	void disable_edge_glitch_filter() {
		DBGCTRL = DBGCTRL & ~std::to_underlying(DBGCTRL_bits::glitch_filter);
	}
	void h0_check_scl() {
...
struct I2C_Hal {
	RockchipPeriph::I2C *instance;
};

static RockchipPeriph::I2C I2C0_;
static RockchipPeriph::I2C I2C1_;
static RockchipPeriph::I2C I2C2_;
static RockchipPeriph::I2C I2C3_;
static RockchipPeriph::I2C I2C4_;
static RockchipPeriph::I2C I2C5_;

inline RockchipPeriph::I2C *I2C0 = &I2C0_;
inline RockchipPeriph::I2C *I2C1 = &I2C1_;
inline RockchipPeriph::I2C *I2C2 = &I2C2_;
inline RockchipPeriph::I2C *I2C3 = &I2C3_;
inline RockchipPeriph::I2C *I2C4 = &I2C4_;
inline RockchipPeriph::I2C *I2C5 = &I2C5_;
