...
TEST_CASE("Rotary General tests" * doctest::skip(true)) {
	auto rotary_half_step = RotaryEncoder{PinDef{GPIO::A, PinNum::_0}, PinDef{GPIO::B, PinNum::_1}, RotaryHalfStep};
	auto rotary_full_step = RotaryEncoder{PinDef{GPIO::A, PinNum::_0}, PinDef{GPIO::B, PinNum::_1}, RotaryFullStep};
...
TEST_CASE("Rotary tests" * doctest::skip(true)) {
	RotaryEnc<RotaryHalfStep, PinDef{GPIO::A, PinNum::_0}, PinDef{GPIO::B, PinNum::_1}> rotary_half_step;
	RotaryEnc<RotaryFullStep, PinDef{GPIO::A, PinNum::_0}, PinDef{GPIO::B, PinNum::_1}> rotary_full_step;
